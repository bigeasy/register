...
require('proof')(4, function (step, deepEqual, ok) {
  ...
  { protocol: 'http:',
    ...
    pathname: '/hello',
    path: '/hello?a=b',
    href: 'http://alan:password@www.foo.com:8080/hello?a=b#c' }, 'full url');
  ...
  { protocol: null,
    ...
    href: '/hello?a=b&d=e%20f#c' }, 'path and parameters');
  ...
  { protocol: null,
    ...
    href: './script.cgi.js?a=b&d=e%20f' }, 'script and parameters');
});
